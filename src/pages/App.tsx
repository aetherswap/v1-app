          ...
          <BodyWrapper>
            ...
            <Web3ReactManager>
              <Switch>
                ...
                <Route exact strict path="/pool/v1" component={PoolV2} />
                {/* <Route exact strict path="/pool" component={Pool} /> */}
                <Redirect from="/pool" to="/pool/v1" />
                {/* <Route exact strict path="/pool/:tokenId" component={PositionPage} /> */}

                <Route
                  exact
                  strict
                  path="/add/v1/:currencyIdA?/:currencyIdB?"
                ...
                <Route exact strict path="/remove/v1/:currencyIdA/:currencyIdB" component={RemoveLiquidity} />
