    ...
    <>
      <PageWrapper>
        ...
        <Heading>
          ...
          <TYPE.largeHeader style={{ margin: 0 }}>Earn rewards by staking AET for xAET</TYPE.largeHeader>
        </Heading>
        <AutoColumn gap="lg" justify="center">
          <InfoCard
            title="Staking rewards"
            description={`The sell tax on our token is distributed as AET proportional to your share of the staking pool. When your AET is staked you receive xAET.

          ${`\n`} Your xAET is continuously compounding, when you unstake you will receive all the originally deposited AET plus any additional tokens accrued from fees.
