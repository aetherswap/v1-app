...
export default function CTACards() {
  ...
  return (
    <CTASection>
      <CTA1 href={'https://docs.aetherswap.org/'}>
        <ResponsiveColumn>
          <HeaderText>{t('Aetherswap V1 is here!')}</HeaderText>
          <TYPE.body fontWeight={300} style={{ alignItems: 'center', display: 'flex', maxWidth: '80%' }}>
            {t('Check out our V1 LP walkthrough and migration guides.')}
          </TYPE.body>
      ...
      <CTA2 href={'https://info.aetherswap.org/#/pools'}>
        <ResponsiveColumn>
