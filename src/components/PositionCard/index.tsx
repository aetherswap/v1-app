          ...
          <AutoColumn gap="8px">
            ...
            {userDefaultPoolBalance && JSBI.greaterThan(userDefaultPoolBalance.quotient, BIG_INT_ZERO) && (
              <RowBetween marginTop="10px">
                <ButtonPrimary
                  ...
                  borderRadius="8px"
                  as={Link}
                  to={`/add/v1/${currencyId(currency0)}/${currencyId(currency1)}`}
                  width="48%"
                >
                  Add
                </ButtonPrimary>
                <ButtonPrimary
                  ...
                  as={Link}
                  width="48%"
                  to={`/remove/v1/${currencyId(currency0)}/${currencyId(currency1)}`}
                >
                  Remove
                </ButtonPrimary>
              </RowBetween>
            ...
            {stakedBalance && JSBI.greaterThan(stakedBalance.quotient, BIG_INT_ZERO) && (
              <ButtonPrimary
                ...
                borderRadius="8px"
                as={Link}
                to={`/aet/${currencyId(currency0)}/${currencyId(currency1)}`}
                width="100%"
              >
