...
import { Feature, featureEnabled } from 'constants/features'
...
const HeaderLinks = styled(Row)`
  ...
  box-shadow: 0 0 5px rgba(64, 10, 171, 0.2), 0 0 7px rgba(64, 10, 171, 0.2);
  margin-left: 4%;
  width: fit-content;
  padding: 4px;
  border-radius: 10px;
...
const AccountElement = styled.div<{ active: boolean }>`
  ...
  box-shadow: 0 0 5px rgba(64, 10, 171, 0.1), 0 0 7px rgba(64, 10, 171, 0.1);
...
const NETWORK_LABELS: Record<ChainId, string> = {
  [ChainId.TESTNET]: 'Ethernity Testnet',
  [ChainId.MAINNET]: '',
}
    ...
    <HeaderFrame showBackground={scrollY > 45}>
      ...
      <HideSmall>
        <HeaderLinks>
          ...
          {chainId && featureEnabled(Feature.FARMS, chainId) && <StyledNavLink
            id={`farm-nav-link`}
            to={'/farm'}
          ...
          {chainId && featureEnabled(Feature.STAKING, chainId) && <StyledNavLink
            id={`stake-nav-link`}
            to={'/stake'}
          ...
          {chainId && featureEnabled(Feature.MY_ASSETS, chainId) && <StyledNavLink
            id={`assets-nav-link`}
            to={'/assets'}
          ...
          <AccountElement active={!!account} style={{ pointerEvents: 'auto' }}>
            {account && userEthBalance ? (
              <BalanceText style={{ flexShrink: 0 }} pl="0.75rem" pr="0.5rem" fontWeight={500}>
                {userEthBalance?.toSignificant(4)} <span style={{ color: '#400aab' }}>ETH</span>
              </BalanceText>
            ) : null}
            <Web3Status />
          </AccountElement>
