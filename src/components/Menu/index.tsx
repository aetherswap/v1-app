...
export const StyledMenuButton = styled.button`
  ...
  padding: 0;
  height: 35px;
  background-color: rgba(64, 10, 171, 0.05);
  ...
  :focus {
    ...
    border: 1px solid rgba(64, 10, 171, 0.5);
  }
...
export default function Menu() {
  ...
  return (
    ...
    <StyledMenu ref={node as any}>
      ...
      {open && (
        <MenuFlyout>
          <MenuItem href="https://docs.aetherswap.io/">
            <BookOpen size={14} />
            <div>Docs</div>
          </MenuItem>
          <MenuItem href="https://twitter.com/aetherswap">
            <Twitter size={14} />
            <div>Twitter</div>
          </MenuItem>
          <MenuItem href="https://discord.gg/7RVwafqFyz">
            <MessageCircle size={14} />
            <div>Discord</div>
          </MenuItem>
          <MenuItem href="https://testnetbridge.ethernitychain.io/">
            <Layers size={14} />
            <div>Bridge</div>
          </MenuItem>
          <MenuItem href="https://faucet.aetherswap.org/">
            <Droplet size={14} />
            <div>Faucet</div>
          </MenuItem>
        </MenuFlyout>
