...
const Container = styled.div<{ hideInput: boolean }>`
  ...
  :hover {
    ...
    box-shadow: 0 0 5px rgba(64, 10, 171, 0.15), 0 0 10px rgba(64, 10, 171, 0.3);
  }
`
...
const CurrencySelect = styled(ButtonGray)<{ selected: boolean; hideInput?: boolean }>`
  ...
  cursor: pointer;
  user-select: none;
  border: 1px solid ${({ selected, theme }) => (!selected ? '#570EE8' ?? 'transparent' : theme.primaryTransparent)};
