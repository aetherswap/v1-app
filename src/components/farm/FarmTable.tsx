...
const FarmContainer = styled(Column)`
  ...
  box-shadow: 0 0 5px rgba(64, 10, 171, 0.1), 0 0 7px rgba(64, 10, 171, 0.3);
  border-radius: 8px;
...
export const PoolRow = styled(Link)`
  ...
  //box-shadow: 0 0 5px rgba(64, 10, 171, 0.05), 0 0 7px rgba(64, 10, 171, 0.05);
  :hover,
  :focus {
    ...
    background: linear-gradient(
      264deg,
      rgba(16, 16, 18, 0.1) 0%,
      rgba(64, 10, 171, 0.05) 25%,
      rgba(16, 16, 18, 0.1) 50%,
      rgba(64, 10, 171, 0.05) 75%,
...
export function FarmTableRow({
  ...
  const totalDepositsText = tvl
    ...
    : `${totalLPStaked?.toSignificant(4, { groupSeparator: ',' }) ?? '-'} AETHER-V1`
