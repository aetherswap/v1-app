...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    //primary colors
    primary1: darkMode ? '#400AAB' : '#400AAB',
    primary2: darkMode ? '#5931A8' : '#5931A8',
    primary3: darkMode ? '#331473' : '#331473',
    primary4: darkMode ? '#240F4D' : '#240F4D',
    primary5: darkMode ? '#24114AAE' : '#24114AAE',

    primary1_30: 'rgba(103, 36, 237, 0.5)', /* #27d2ea */
    primaryTransparent: 'rgba(103, 36, 237, 0.2)', /* #27d2ea */

    // color text
    primaryText1: darkMode ? '#400AAB' : '#400AAB',

    // secondary colors
    secondary1: darkMode ? '#240F4D' : '#240F4D',
    secondary2: darkMode ? '#0F012B26' : '#D3BDFF',
    secondary3: darkMode ? '#0F012B26' : '#D3BDFF',

    secondary1_30: 'rgba(31, 5, 84, 0.3)',
    secondary1_10: 'rgba(31, 5, 84, 0.1)',
